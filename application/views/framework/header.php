...
<body>
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <a class="brand" href=<?php echo $this->config->item('base_url')."catalog/index/";?>>错误报告系统</a>
            <ul class="nav">
                <li class="active"><a href=<?php echo $this->config->item('base_url')."catalog/index/";?>>Lua错误页面</a></li>
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">统计页面<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href=<?php echo $this->config->item('base_url')."catalog/topbug/";?>>最多出错</a></li>
                        <li><a href=<?php echo $this->config->item('base_url')."catalog/newest/";?>>最新版本</a></li>
                    </ul>
                </li>
                <li class="dropdown">
